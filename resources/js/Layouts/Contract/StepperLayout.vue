<template >
    <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
        <ol class="flex items-center w-full mb-4 sm:mb-5">
            ...
            <li class="flex w-full items-center after:content-['Mandar_contrato'] after:w-full after:h-1 after:border-b after:border-gray-100 after:border-4 after:inline-block dark:after:border-gray-700">
                <div class="flex items-center justify-center w-10 h-10  rounded-full lg:h-12 lg:w-12 dark:bg-gray-700 shrink-0"
                    :class="{'bg-blue-100' : (step === 'one')}"
                >
